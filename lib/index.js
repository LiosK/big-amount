...
export class BigAmount {
     ...
     * @category Arithmetic Operation
     */
    ichangeDenominator(newDen, roundingMode = "HALF_EVEN") {
        if (this.den === newDen) {
            return this.verify();
        }
        if (this.den < 0n) {
     ...
     * @category Arithmetic Operation
     */
    changeDenominator(newDen, roundingMode = "HALF_EVEN") {
     ...
     * @category Conversion
     */
    toFixed(digits = 0, { decimalSeparator = ".", groupSeparator = "", roundingMode = "HALF_EVEN", } = {}) {
